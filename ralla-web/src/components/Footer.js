...
export default function Footer() {
    ...
    // Admin නම් Footer එපා
    if (pathname && pathname.startsWith("/admin")) {
        return null;
    }

    return (
        <footer className="bg-black text-gray-400 py-12 px-4 md:px-16 border-t border-gray-800 mt-0.5">
            <div className="max-w-7xl mx-auto">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-sm">
                    <div className="flex flex-col gap-3">
                        <FooterLink text="Audio Description" />
                ...
                <div className="mt-12 text-xs text-gray-500">
                    <button className="border border-gray-500 px-4 py-1 mb-4 hover:text-white hover:border-white transition">
                        Service Code
                    </button>
                    <p>&copy; 2025 Rella Streaming, Inc.</p>
                </div>
...
// පොඩි Helper Component එකක් Link වලට
...
// පොඩි Helper Component එකක් Icon වලට
function SocialIcon({ path }) {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="w-6 h-6 hover:text-white cursor-pointer transition" viewBox="0 0 24 24">
            <path d={path} />
        </svg>
    );
}